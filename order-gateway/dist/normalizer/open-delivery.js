...
exports.normalizeOpenDeliveryToFleetbase = void 0;
const normalizeOpenDeliveryToFleetbase = (openDeliveryPayload) => {
        ...
        data: {
            ...
            attributes: {
                ...
                payload: {
                    ...
                    entities: (openDeliveryPayload.items || []).map((item) => ({
                        name: item.name,
                        description: item.options?.map((opt) => opt.name).join(', ') || "",
...
exports.normalizeOpenDeliveryToFleetbase = normalizeOpenDeliveryToFleetbase;
